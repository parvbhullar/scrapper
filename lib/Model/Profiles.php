...
final class Profiles extends Model
{
    ...
    protected static $attrs = array(
        ...
        'profileStore' => array('model'=> 'Model\\ProfileStore', 'type'=>'embeds'), # array('model'=>'Purekid\Mongodm\Test\Model\Book','type'=>'reference') 1 targetDocument="ProfileStore", 2 cascade="persist"
        'industry' => array('default'=>'','type'=>'string'),
        'locality' => array('default'=>'','type'=>'string'),
        //** array field */
        'outBoundProfilesLinks' => array('model'=> 'Model\\OutBoundProfilesLinks', 'type'=>'embeds'), #targetDocument="OutBoundProfileLinks", cascade="persist"
        'experience' => array('model'=> 'Model\\Experience', 'type'=>'embeds'), #targetDocument="Experience", cascade="persist"
        'education' => array('model'=> 'Model\\Education', 'type'=>'embeds'), #targetDocument="Education", cascade="persist"
